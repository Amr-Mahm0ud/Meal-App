...
class MyProv with ChangeNotifier {
  ...
  void editFavorites(mealId) {
    int index = favoriteMeals.indexWhere((meal) => meal.id == mealId);
    if (index >= 0) {
  ...
  bool isFavorite(mealId) {
    bool res = favoriteMeals.any((meal) => meal.id == mealId);
    return res;
  }
...
class Themes {
  static final darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme.fromSwatch(
        primarySwatch: Colors.deepOrange, accentColor: const Color(0xFF393E46)),
  ...
  static final lightTheme = ThemeData(
    primarySwatch: Colors.deepOrange,
    colorScheme: ColorScheme.fromSwatch(
        primarySwatch: Colors.deepOrange, accentColor: const Color(0xFFEDEBCA)),
